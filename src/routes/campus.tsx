...
//         />
//       </div>
//       <div className="px-3 py-1.5 text-xs text-foreground/70 truncate bg-black/60 shrink-0">{v.title}</div>
//     </div>
//   );
// }
...
//           <button onClick={onBack} className="self-start inline-flex items-center gap-2 rounded-lg border border-white/20 bg-black/30 backdrop-blur px-4 py-2 text-sm font-medium text-foreground/90 hover:border-primary/60 transition-colors">
//             <I.Back /> Back
//           </button>
//           <div>
//             <div className={`label-caps text-[11px] mb-1 ${TINT_TEXT[section.tint]}`}>{section.eyebrow}</div>
//             <h2 className="text-2xl sm:text-4xl font-semibold tracking-tight text-foreground leading-[1.05]">{section.title}</h2>
//           </div>
//         </div>
//       </div>
...
//               <p className="text-sm sm:text-[15px] text-foreground/80 leading-relaxed">{section.description[0]}</p>
//               <p className="text-sm sm:text-[15px] text-foreground/70 leading-relaxed">{section.description[1]}</p>
//             </div>
...
//                   <li key={i} className="flex items-start gap-2 text-xs sm:text-sm text-foreground/80 leading-snug">
...
//                     <div className="text-[10px] uppercase tracking-wide text-foreground/50 truncate">{s.label}</div>
//                     <div className="text-sm font-semibold text-foreground truncate">{s.value}</div>
//                   </div>
//                 </div>
//               ))}
//             </div>
...
// import { useEffect, useRef, useState, type ReactNode } from "react";
// import { SectionHeader } from "@/components/SectionHeader";
// import overviewImg from "@/assets/campus/Overview.png";
// import globalImg from "@/assets/campus/gen-global.jpg";
// import connectivityImg from "@/assets/campus/gen-connectivity.jpg";
// import hostelsImg from "@/assets/campus/gen-hostels.jpg";
// import libraryImg from "@/assets/campus/gen-library.jpg";
...
//     bgImage: overviewImg,
//     videos: [
//       { id: "MU4ps6jPdvw", title: "Campus Drone Tour in 4K" },
//       { id: "0xbEHK_nqLc", title: "Campus Tour of IIT Bombay" },
//       { id: "BgXaxIogQcU", title: "IIT Bombay Campus Tour" },
//       { id: "z8WkhSkx5Eg", title: "Full Campus Tour" },
//     ],
//     stats: [
//       { icon: <I.Map />, label: "Area", value: "545 acres" },
//       { icon: <I.Building />, label: "Established", value: "1958" },
...
//   const v = videos[index];
//   return (
//     <div className="h-full w-full rounded-xl overflow-hidden border border-white/20 bg-background shadow-[0_0_40px_-10px_rgba(0,0,0,0.7)] flex flex-col">
//       <div className="relative w-full flex-1 min-h-0">
//         <iframe
//           key={v.id + index}
//           src={`https://www.youtube-nocookie.com/embed/${v.id}?autoplay=1&mute=1&controls=0&rel=0&modestbranding=1&loop=1&playlist=${v.id}`}
...
//         />
//       </div>
//       <div className="px-3 py-1.5 text-xs text-foreground/70 truncate bg-background/60 shrink-0">{v.title}</div>
//     </div>
//   );
// }
...
//       {/* Hero banner — image only here */}
//       <div className="relative h-[22%] w-full shrink-0 overflow-hidden">
//         <img src={section.bgImage} alt={section.title} className="absolute inset-0 w-full h-full object-cover" style={{ objectPosition: "center 80%" }} />
//         <div className="absolute inset-0 bg-gradient-to-t from-black via-black/40 to-black/10" />
//         <div className="relative z-10 h-full flex flex-col justify-between p-4 sm:p-6">
//           <button onClick={onBack} className="self-start inline-flex items-center gap-2 rounded-lg border border-white/20 bg-background/30 backdrop-blur px-4 py-2 text-sm font-medium text-foreground/90 hover:border-primary/60 transition-colors">
//             <I.Back /> Back
//           </button>
//           <div>
//             <div className={`label-caps text-[11px] mb-1 ${TINT_TEXT[section.tint]}`}>{section.eyebrow}</div>
...
// Outer coverflow card images — AI-generated
import overviewImg from "@/assets/campus/NEWNEW (1).jpg";
import globalImg from "@/assets/campus/overview2.jpg";
import connectivityImg from "@/assets/campus/connectivity.jpg";
import hostelsImg from "@/assets/campus/cardhostel2.jpg";
import libraryImg from "@/assets/campus/Library.jpg";
import sportsImg from "@/assets/campus/NEWNEW (2).jpg";

// Inner detail-view hero images — real photos (CHECK/SWAP mapping below if wrong)
import overviewHero from "@/assets/campus/Overview.png";
import globalHero from "@/assets/campus/OVERVIEW3.jpg"; 
import connectivityHero from "@/assets/campus/new (3).jpg";
import hostelsHero from "@/assets/campus/hostels.jpg"; 
import libraryHero from "@/assets/campus/pexels-repuding-12064.jpg";
import sportsHero from "@/assets/campus/sports.jpg"; 
...
type SectionConfig = {
  ...
  eyebrow: string;
  tint: Tint;
  cardImage: string;  // outer coverflow card
  heroImage: string;  // inner detail-view banner
  heroPosition: string; // ← NEW: your manual styling knob per section
  videos: VideoItem[];
  stats: Stat[];
  description: string[];
  features: string[];
...
const SECTIONS: SectionConfig[] = [
  {
    id: "overview", title: "Overview", eyebrow: "Block 01", tint: "red",
    cardImage: overviewImg,
    heroImage: overviewHero,
  ...
  {
    id: "connectivity", title: "Connectivity", eyebrow: "Block 03", tint: "green",
    cardImage: connectivityImg,
    heroImage: connectivityHero,
    heroPosition: "center 50%",
    videos: [
      { id: "5IvBqu3-N6s", title: "Campus Tour | Access & Facilities" },
      { id: "J1C5nb2QSHo", title: "Getting Around Campus" },
      { id: "YpMbzttowYE", title: "NIGHT LIFE" },
    ],
    stats: [
      { icon: <I.Train />, label: "Nearest rail", value: "Kanjurmarg ~3km" },
      { icon: <I.Map />, label: "Metro (Line 6)", value: "~500m, u/c" },
  ...
  {
    id: "hostels", title: "Hostels", eyebrow: "Block 04", tint: "gold",
    cardImage: hostelsImg,
    heroImage: hostelsHero,
    heroPosition: "center 60%",
    videos: [
      { id: "5IvBqu3-N6s", title: "Hostel Tour" },
      { id: "rnIDk71kyGc", title: "FULL Tour" },
      { id: "yqBA_3t4AH0", title: "Inside a Premium Hostel" },    
      { id: "liMQFierVBM", title: "Inside a Premium Hostel" }, 
      { id: "KYSD9b6QMik", title: "New Crazy Hostels 2025" },
      { id: "dxcJ6ZBAd0A", title: "Inside a Premium Hostel" },  
      { id: "qJcPF0xvKAA", title: "Inside a Premium Hostel" }
    ],
    stats: [
      { icon: <I.Building />, label: "Total hostels", value: "18+" },
      { icon: <I.Users />, label: "Capacity", value: "5,000+" },
  ...
  {
    id: "library", title: "Library & Academics", eyebrow: "Block 05", tint: "blue",
    cardImage: libraryImg,
    heroImage: libraryHero,
    heroPosition: "center 30%",
    videos: [
      { id: "y995AuEg_54", title: "Library & Academic Buildings" },
      { id: "QasnE4po8vw", title: "CSE DEPARTMENT TOUR" },
      { id: "vO5PQup0P-0", title: "Central Library Tour" },
    ],
    stats: [
      { icon: <I.Book />, label: "Books", value: "3+ lakh" },
      { icon: <I.Chip />, label: "E-journals", value: "50,000+" },
  ...
  },
  {
    ...
    videos: [
      { id: "XQdrhX0MsLg", title: "Gymkhana Tour" },
      { id: "oYVViPVGsoU", title: "Gymkhana Tour" },
      { id: "G2CsnA3WlXM", title: "Full Fitness Experience" },    
    ],
    stats: [
      { icon: <I.Trophy />, label: "Indoor complex", value: "SAC (AC)" },
      { icon: <I.Pool />, label: "Pools", value: "2 (Olympic 50m)" },
...
function Coverflow({ onOpen }: { onOpen: (id: string) => void }) {
  ...
  useEffect(() => {
    if (paused) return;
    const t = setInterval(() => setCenter((c) => (c + 1) % n), 1000);
    return () => clearInterval(t);
  }, [paused, n]);
...
{/* Left click zone */}
  <button
    ...
    className="absolute left-0 top-0 h-full w-[15%] z-[60] cursor-pointer bg-transparent"
  />
  {/* Right click zone */}
  <button
    type="button"
    ...
    className="absolute right-0 top-0 h-full w-[15%] z-[60] cursor-pointer bg-transparent"
  />
      <div className="text-center px-6 shrink-0">
        <div className="label-caps text-primary text-[11px] mb-4 tracking-[0.25em]">Explore the Campus</div>
        <h1 className="text-3xl sm:text-5xl font-semibold tracking-tight">545 acres, six stories.</h1>
            ...
            {SECTIONS.map((s, i) => {
              ...
              return (
                <button
                  ...
                  aria-label={`Open ${s.title}`}
                  className="absolute w-[210px] sm:w-[260px] h-[280px] sm:h-[340px] rounded-2xl overflow-hidden border transition-all duration-200 ease-out cursor-pointer focus:outline-none focus:ring-2 focus:ring-primary/60"
                  style={{
                    transform: `translateX(${x}px) scale(${scale})`,
                    opacity,
                    zIndex: isCenter ? 50 : 40 - abs,
                ...
                >
                  <img src={s.cardImage} alt={s.title} className="absolute inset-0 w-full h-full object-cover filter brightness-90 contrast-110 saturate-75 pointer-events-none" />
                  <div className="absolute inset-0 bg-blue-950/25 mix-blend-overlay pointer-events-none" />
                  <div className={`absolute inset-0 bg-gradient-to-t from-black/90 via-black/30 to-transparent pointer-events-none ${isCenter ? "" : "opacity-80"}`} />
                  {isCenter && <div className="absolute inset-0 ring-1 ring-inset ring-white/10 rounded-2xl animate-pulse-dot pointer-events-none" />}
                  <div className="absolute inset-x-0 bottom-0 p-4 pointer-events-none">
...
function SectionDetail({ section, onBack }: { section: SectionConfig; onBack: () => void }) {
  return (
    <div className="relative h-full w-full overflow-hidden flex flex-col">
      {/* Hero banner — image only here */}
      <div className="relative h-[22%] w-full shrink-0 overflow-hidden">
        <img src={section.heroImage} alt={section.title} className="absolute inset-0 w-full h-full object-cover" style={{ objectPosition:section.heroPosition}} />
        <div className="absolute inset-0 bg-gradient-to-t from-black via-black/40 to-black/10" />
        <div className="relative z-10 h-full flex flex-col justify-between p-4 sm:p-6">
          <button onClick={onBack} className="self-start inline-flex items-center gap-2 rounded-lg border border-white/20 bg-background/30 backdrop-blur px-4 py-2 text-sm font-medium text-foreground/90 hover:border-primary/60 transition-colors">
            <I.Back /> Back
          ...
          <div>
            <div className={`label-caps text-[11px] mb-1 ${TINT_TEXT[section.tint]}`}>{section.eyebrow}</div>
            <h2 className="text-2xl sm:text-4xl font-semibold tracking-tight leading-[1.05] text-white">{section.title}</h2>
          </div>
        </div>
      </div>
...
//             <div className="flex-1 min-h-0">
//               {/* <MapEmbed query={section.mapQuery} className="h-full w-full" /> */}
//               <LeafletMap query={section.mapQuery} sectionId={section.id} className="h-full w-full" />
//             </div>
//           </div>
//         </div>
//       </div>
